...
export default function Topbar({ BGcolor }:TopbarProps) {
    ...
    let borderStyle = 'bg-cambridge w-full h-1';

    if (BGcolor) {
        borderStyle = `${BGcolor} w-full h-1`;
    }
    ...
    return (
        <header className="bg-rblack w-full sticky top-0 z-50">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <Link href="/resume" className="text-md font-semibold leading-6 text-bright hover:text-cambridge">
                    Resum&eacute;
                </Link>
                </Popover.Group>
