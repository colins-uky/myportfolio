            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-around h-16 text-bright">
                    ...
                    <div className="relative group">
                        ...
                        <Link href="/projects" className="hover:text-cambridge hover:underline decoration-2 underline-offset-4 text-center">
                            Projects
                        </Link>

                        <div className="absolute left-1/2 transform -translate-x-1/2 hidden w-[15vw] px-10 h-[15vh] rounded-md bg-rblack text-white group-hover:block">
